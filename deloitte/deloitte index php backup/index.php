...
<head>
    ...
    <title>Deloitte | _projects | Vedika Bhasin</title>

    <!-- <link rel="stylesheet" href="fonts/Helvetica-W01-Roman/c5bd605b45237a12c99133fa9d7cae49?family=HelveticaW01-Roman" > -->
...
<body class="deloitte-page-body">
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="portfolio-intro-header bg-white p-4 my-md-5 my-4">
            ...
            <!-- <div class="next-page-arrow d-flex justify-content-between">                

              <a href="minute-maid.html">&#x2039;</a>
            ...
            <div class="p-intro-header-txt-container mx-auto text-center">
              ...
              <p class="port-subhead-txt-color port-subhead-txt">/SCADpro x Deloitte Collaboration, Copywriting, Illustration, Interactive Design, Physical Deliverables, Project Management, UX Research & Design, Visual Design</p>
    ...
    <div class="container custom_container">
      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <p class="fontSize16px deloitte_nda_txt text-center">Under an NDA, please reach out for the password.</p>
  ...
  <section class="deloiite_loop_area pb-3 pb-md-5">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-7">
          ...
          <div class="deloiite_loop_img_box">
            ...
            <a data-toggle="modal" href="#deloitte_full_login_modal"><img src="../assets/img/deloitte/LOOP.png"
                alt="LOOP"></a>
        ...
        <div class="col-12 col-md-5">
          ...
          <div
            class="deloiite_loop_full_process d-flex justify-content-md-center justify-content-end align-items-center h-100">

            <a data-toggle="modal" id="deloiite_loop_full_process_link"
              class="deloiite_loop_full_process_link text-decoration-none d-inline-block mt-4 text-md-left text-right"
              href="#deloitte_full_login_modal">VIEW FULL PROCESS</a>



            <!-- The Modal -->

            <div class="modal fade" id="deloitte_full_login_modal">
                ...
                <div class="modal-content text-center">
                  ...
                  <div class="modal-body">
                    ...
                    <div>
                      ...
                      <form id="deloitte_login_form" method="POST">

                        <div class="deloitte_pass_box">

                          <input type="password" name="password">

                        </div>

                        <div id="deloitte_errorMsg_box">



                        </div>

                        <div class="deloitte_submit_box">
  ...
  <!-- Deloitte_Loop Area === End -->
    ...
    <script>
        ...
        $(document).ready(function(){
          $("#deloitte_login_form").submit(function(e){
            ...
            $.post("../password.php",
                ...
                function(data){
                  ...
                  if (response.status == "success") {
                    ...
                    window.location.href = '../deloitte-full-process';

                  }else{
                      document.getElementById("deloitte_errorMsg_box").innerHTML = "<span style='color: red;''>Please enter the correct password.</span>";
                  }
                }
              );
          });
...
<?php
  ...
  if(isset($_SESSION['asad3']) && $_SESSION['asad3'] = 'My Name3'){ ?>

  <script>
      $('#deloitte_full_login_modal').modal('show');
  </script>
